...
if show_figure && (plot_type ==1 )
    ...
    for i = 1:num_exps
        ...
        num_cell = exp{i}.num_cell;
        for j = 1:num_cell  % Plot the values before normalization
...
for i = 1:num_exps    
    ...
    % loess smooth
    sm_int = smooth(all_time, all_int, smooth_nbhd*num_cell, 'loess');
...
for i = 1:num_exps    
    ...
    std_error(:,i) = std(interp_value,0,2)/sqrt(num_cell);
