...
if draw_figure
    figure; imagesc(im); colormap jet; hold on;
...
for i =1:num_fan
    ...
    %%% 8/14/2019 Kathy
    fan_x = zeros(num_point, 1); 
    fan_y = zeros(num_point, 1);
    p = zeros(num_point, 2); 
    %%%
    for j=1:num_point
        if ~has_fan_file
