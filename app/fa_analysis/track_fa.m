...
%% Calculating tracking of the fas
movie_info = get_movie_info(data,  'load_file',0);
%frame_index = 1:length(data.image_index);
tracksFinal = get_track(data, movie_info, 'load_file', 0, 'save_file', 1);
...
'image_index', data.image_index,'load_file', 0,'track_index', track_index, 'save_file', 1);
